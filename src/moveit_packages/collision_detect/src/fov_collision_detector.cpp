...
visualization_msgs::Marker createBoxMarker(float offset_x, float offset_y, float offset_z, uint32_t action) {
    ...
    vb_marker.scale.x = 0.0007;
    vb_marker.scale.y = 0.0007;
    vb_marker.scale.z = 0.0007;
...
int main(int argc, char** argv)
{
    ...
    fov_marker.scale.x = 0.0008;
    fov_marker.scale.y = 0.0008;
    fov_marker.scale.z = 0.0008;
